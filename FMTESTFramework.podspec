...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/fanfansky7/TESTFrameworkToCocoaPods"
  ...
  spec.source       = { :git => "https://github.com/fanfansky7/TESTFrameworkToCocoaPods.git", :tag => "#{spec.version}" }
  ...
  # spec.frameworks = "SomeFramework", "AnotherFramework"
   spec.vendored_frameworks = "FMFramework.framework"
  # spec.library   = "iconv"
